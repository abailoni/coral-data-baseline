...
# Script arguments:
# -----------------------------------------------------
# TODO: convert to script arguments
IGNORE_LABEL = 99
HAS_IGNORE_LABEL = True

# Relabel annotations from 0 to N-labels in the given dataset:
RELABEL_CONSECUTIVE = True

# Useful when you want to train on multiple datasets simultaneusly.
# If True, a unique set of consecutive annotation labels will be generated for all given datasets (0, nb_labels_in_all_given_datasets).
# If False, each of the given datasets will have its own set of labels: (0, nb_labels_in_dataset_1), (0, nb_labels_in_dataset_2)...
RELABEL_ALL_DATASETS_CONSISTENTLY = True

# Normalize input images:
NORMALIZE_RAW = True

# path to labe-colors file:
labels_colors = pd.read_csv("/scratch/bailoni/pyCh_repos/coral-data-baseline/data/labels_and_colors.csv")

# Directory with original Coral data:
# original_data_dir = "/g/scb/alexandr/shared/alberto/datasets/coral_data/Coral Data Sharing"
original_data_dir = "/scratch/bailoni/datasets/coral_data/Coral Data Sharing"

# Path where the output hdf5 datasets will be saved:
main_dir = os.path.join("/scratch/bailoni", "datasets/coral_data")

# Postfix appended to the end of the final hdf5 dataset that is generated by the script:
OUT_postfix = "_v2"

# -----------------------------------------------------
# -----------------------------------------------------
# In this dictionary, comment out only the datasets that you want to process:
datasets = {
    ...
    "NASA": {'root-raw': "NASA Ames NeMO Net - Alan Li/2D Projections/RGB Images", #FIXME: some of the annotations are crap
             ...
             "labels_type": "_annotation.png",
             "images_info": "/scratch/bailoni/pyCh_repos/coral-data-baseline/data/NASA_species_stats_val_train_test_split_v2.csv"},
    # "NOAA": {
...
def main_function(mode="convert_to_hdf5"):
    ...
    global labels_colors, main_dir, original_data_dir
    ...
    for data_name in datasets:
        ...
        for file, split in zip(image_names, train_val_split):
            ...
            # Some entries in the csv should be skipped:
            if not os.path.exists(file_path):
                print("Warning: '{}' not found. Skipping it.".format(file_path))
                continue
        ...
        print("Done collecting images info")
    ...
    for data_name in datasets:
        ...
        print("Output hdf5 dataset: ", hdf5_path)
